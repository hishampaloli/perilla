...
const EditJobForm = ({ setEdit }: { setEdit: any }) => {
  ...
  useEffect(() => {
    ...
    setJobDesignation(jobData?.jobDesignation!);
    ...
    setApplicationQuestions(jobData?.applicationQuestions!);
    setJobKeyRoles(jobData?.jobKeyRoles!);
  }, [data]);
